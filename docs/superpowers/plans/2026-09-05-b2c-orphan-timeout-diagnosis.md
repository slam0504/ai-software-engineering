...
## 尚未完成
- Task 1 與 Task 2 Step 1 完成（本機，含第二、三輪 P1 修正與強制控制）；Task 2 Step 2 待 owner 授權推送；Task 2 Step 3、Task 3 未執行。plan rev5／rev6／rev7 已 commit（`a48018c`／`6ae5624`／`438e80e`），rev8 待 commit。
