...
- [ ] **Wails GUI 證據與涵蓋限制裁定**：本票的 GUI 證據由 **agent 透過 osascript 操作**取得（非人工操作、非 owner 確認），逐案結果見 §12.4；**寫入進行中**與**重新送核導向**兩項 GUI 未涵蓋，owner 2026-09-08 裁定不追加 GUI、由 G6／H1 系列與 G4／G5／H4-S／H5-P 承接。本格待 owner 對「GUI 證據與其涵蓋限制」作成裁定。
