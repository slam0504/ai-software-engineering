...
- [ ] 後續每次**真實**修訂（例如 owner 複核 PR #3 內容產生的修正、plan 回填）各一次 push → 樣本 2–5；每次記 D6 欄位；失敗與排除保留；不足五次即回報缺口。**樣本回填衍生的 CI 不是製造下一次修訂的理由。**
