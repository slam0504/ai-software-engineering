...
> 版本：v2.3（2026-09-02，治理修正——§6.7 新增「變異目標」規則：mutation 須植入本票新增／修改且直接承載本票契約的 production code，不得下沉至共用基礎設施；造成非預期 panic 或跨範圍連帶失敗者不構成「紅在正題」）
> 前版：v2.2（2026-09-01，治理修正——mutation acceptance table 預設 N/N 全跑門檻，新增 §6.7；同步校正 §4／§6.3／§11 的「抽驗」措辭以免與新規則矛盾）；v2.1（2026-08-05）
