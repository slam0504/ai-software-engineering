...
**小計（rev15 更新——B1b 0.3→0.4）**：A 軌 3.0 pt（30 hr）｜B 軌 **11.71 pt（117.05 hr）**｜C 軌 3.5 pt（35 hr）｜**合計 18.21 pt（約 182.05 hr 實際工作）**。排程換算（團隊 throughput 約 0.6 pt／day）為另一維度，於排程時另算，不與工程量混用。
