# Pre-M4 Readiness Backlog（rev14·估點版）

> 版本：rev14（2026-09-04，**B1a-4 整合驗收完成並關票、B1a aggregate 關閉——狀態更新，估點不變；B1b 與 B2 票面依 B1a-4 裁定回寫承接範圍**）
> 前版：rev13（2026-09-04，B1a-3 實作完成並關票——狀態更新，估點與票面範圍不變）；rev12（2026-09-04，B1a-3 Gate A 發現 #6 核心 oracle 失效——票面範圍由「一行 `deadline` 重設」擴為「`deadline` 重設 ＋ fixture／oracle 改寫」，重估 0.48→0.77 pt）；rev11（2026-09-04，B1a-3 preflight 裁定——#5 改判 no-change disposition、#6 一行修法確認、B1a-3 重估 0.66→0.48 pt）；rev10（2026-09-04，B1a-2 實作完成並關票——狀態更新，估點與票面範圍不變）；rev9（2026-09-03，B1a-1 實作完成並關票——狀態更新，估點與票面範圍不變）；rev8（2026-09-03，B1a preflight 實測落地——`TestAppServerTerminateKillsGroup` 未進入 escalation 分支之事實修正、#1 判類 2 並釘死邊界、B1a 逐條 bottom-up 重估後拆為三張施工票＋一張整合驗收票）；rev7（2026-08-31，C1 驗收條件補「Forge 回傳 eligible CR 不得經篩除後假綠」案例）；rev6（2026-08-28，B6 依 owner 於 B6 plan gate 第三輪裁決拆為 B6a/B6b——1.45／0.6 pt；C1 相依同步改 B6a＋B6b；其餘票面不變）
> 狀態：**B1a-1 已完成（2026-09-03，Gate 3 APPROVED，`82caf8b`／`f7ad1ed`）；B1a-2 已完成（2026-09-04，Gate B APPROVED，`7b1bb0c`／`05069e2`／`b0a8404`）；B1a-3 已完成（2026-09-04，Gate B APPROVED，plan `d92f4a2`／implementation `39aa732`）；B1a-4 已完成（2026-09-04，Gate A APPROVED 後文件落地，plan `b91f16f`／§7.1＋living `bc2a5ec`／本 rev）；**B1a aggregate 已關閉**；B1 票整體仍開啟，待 B1b**——**B1a-1／B1a-2／B1a-4 估點於 rev8 通過 owner review（2026-09-03）；B1a-3 已於 rev12 重估（rev8 0.66 → rev11 0.48 → rev12 **0.77 pt**）並取代先前所有版本**；**A 軌五票（A1a／A1b／A2／A3／A4）、B 軌未完成之其餘票（B1b／B2／B3a-1／B3a-2／B3b／B4）、C 軌四票（C1a／C1b／C1c／C2）之估點仍待 owner review**（B5／B6a／B6b 已完成，不列入待估 review）——D 軌待立項後估（rev4 凍結）
...
| B1b | 前端兩條候選重現與處置＋**更新既有** living 有效名單文件（`docs/architecture/wall-clock-test-register.md`，B1a-4 已建立 v1；rev14 消除「建立／更新」歧義） | 0.3 | 估點暫不調整，於 B1b plan gate 再核對 |
